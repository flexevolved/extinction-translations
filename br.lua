local my_language = {
	...
	unable_to_find_booster = "Não foi possível encontrar um booster neste ID.",
	wait_already_player_boost = "Por favor aguarde antes de utilizar este booster. Já possuí um booster de jogador ativo.",
	wait_already_crew_boost = "Por favor aguarde antes de utilizar este booster. Já possuí um booster de gangue ativo.",
	wait_already_server_boost = "Por favor aguarde antes de utilizar este booster. Já possuí um booster de servidor ativo.",
	booster_activated = "Booster ativado por ~g~%s minutos~w~! ~b~XP +%s%%",
	server_booster_activated = "~b~%s~w~ ativo um booster de servidor por ~g~%s minutos~z~! ~b~XP +%s%%",
	crew_booster_activated = "~b~%s~w~ ativou um booster de gangue por ~g~%s minutos~z~! ~b~XP +%s%%",
	no_booster = "Você não possuí nenhum booster.",
